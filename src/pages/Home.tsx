...
export function Home() {
  ...
  return (
    <>
      ...
      <section className="py-space-xl bg-brand-surface border-b border-brand-border">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-space-md text-brand-muted text-sm">
              <div className="flex items-center gap-space-sm">
                <span className="w-4 h-4 flex items-center justify-center text-brand-success">
                  ✓
                </span>
            ...
            <div className="flex items-center gap-space-sm">
              <Link to="/contact" className="px-space-md py-space-sm bg-brand-primary text-brand-surface text-sm font-display font-semibold hover:bg-brand-primary-light transition-colors">
                Get Started
              </Link>
            </div>
          </div>
      ...
      <section className="py-space-4xl bg-gradient-to-b from-brand-surface to-brand-surface-subtle">
        <div className="container mx-auto px-4">
          <div className="text-center mb-space-3xl">
            ...
            <p className="text-brand-body font-body text-xl max-w-3xl mx-auto">
              Built for scale, designed for precision. Our platform handles complexity
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-center gap-space-md mb-space-md">
                  <div className="w-16 h-16 bg-brand-primary flex items-center justify-center text-brand-accent group-hover:scale-110 transition-transform">
                    {feature.icon}
                  </div>
                  <div>
                    <h3 className="font-display text-h3 font-bold text-brand-text mb-1">
                      {feature.title}
                    </h3>
                    <p className="text-brand-muted text-sm font-semibold tracking-wider uppercase">
                      {feature.metrics}
                    </p>
                  </div>
                </div>
                <p className="text-brand-secondary text-body leading-relaxed">
                  {feature.description}
                </p>
              </motion.div>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-space-3xl items-center">
            <div>
              ...
              <p className="text-brand-secondary-light text-body text-xl leading-relaxed mb-space-xl">
                From origin to final delivery, we handle every link in your supply chain
                with precision and care. Our end-to-end services scale with your business.
              </p>
            ...
            <div>
              <div className="grid md:grid-cols-2 gap-space-lg">
                {services.map((service, index) => (
                  ...
                  >
                    <div className="w-14 h-14 bg-brand-surface flex items-center justify-center text-brand-accent mb-space-md group-hover:scale-110 transition-transform">
                      {service.icon}
                    </div>
                    <h3 className="font-display text-h3 font-bold text-brand-surface mb-space-sm">
                      {service.title}
                    </h3>
                    <p className="text-brand-secondary text-body text-sm leading-relaxed mb-space-md">
                      {service.description}
                    </p>
      ...
      <section className="py-space-4xl bg-brand-accent relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-brand-surface text-body text-xl max-w-3xl mx-auto mb-space-2xl">
            Join 500+ enterprise companies that trust MOVVE with their most critical
          ...
          <div className="flex flex-wrap justify-center gap-space-md">
            <Link
              to="/contact"
              className="px-space-xl py-space-md bg-brand-surface text-brand-primary font-display font-bold text-lg hover:bg-brand-surface-subtle transition-colors shadow-commanding"
            >
              Request Demo
            </Link>
            <Link
              to="/tracking"
              className="px-space-xl py-space-md bg-brand-accent-dark text-brand-surface border-2 border-brand-surface/30 font-display font-bold text-lg hover:bg-brand-accent transition-colors"
            >
              Track Shipment
            </Link>
          </div>
